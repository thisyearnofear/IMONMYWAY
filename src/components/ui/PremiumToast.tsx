...
function PremiumToast({ toast, onClose }: ToastProps) {
  ...
  return (
    <div
      className={cn(
        'border border-gold-500/20 relative overflow-hidden rounded-xl',
    ...
    >
      ...
      <button
        onClick={onClose}
        className="flex-shrink-0 w-8 h-8 rounded-lg border border-gold-500/20 hover:bg-white/10 transition-colors flex items-center justify-center group"
      >
        <svg 
