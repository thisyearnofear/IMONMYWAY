    ...
    <div className="bg-white rounded-lg shadow-md border border-gray-200 p-6">
        ...
        {isLoading ? (
          ...
          <>
            ...
            <div className="flex justify-between items-center">
              ...
              <span className="font-medium">{formatTime(bet.deadline)}</span>
            </div>
      ...
      <div className="mt-4 text-xs text-gray-500">
        <div className="flex justify-between">
          <span>
            Start: {bet.startLocation.lat.toFixed(4)},{" "}
            {bet.startLocation.lng.toFixed(4)}
          </span>
          <span>
            Target: {bet.targetLocation.lat.toFixed(4)},{" "}
            {bet.targetLocation.lng.toFixed(4)}
          </span>
        </div>
      </div>
    </div>
